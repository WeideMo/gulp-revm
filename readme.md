...
```
$ npm install --save-dev gulp-revm
```
...
```json
{
	"css/unicorn.css": "css/unicorn.css?d41d8cd98f",
	"js/unicorn.js": "js/unicorn.js?273c2cin3f"
}
```
...
This plugin does not support streaming. If you have files from a streaming source, such as browserify, you should use [gulp-buffer](https://github.com/jeromew/gulp-buffer) before `gulp-revm` in your pipeline:
...
- [gulp-revm-collector](https://github.com/WeideMo/gulp-revm-collector) - Static asset revision data collector
